# ip-cam-face-recognition
   ...
   Esta biblioteca foi testada através de um código que carrega e processa rostos de pessoas em formato .jpg e executa o reconhecimento entre os rostos cadastrados e os frames de uma streaming IP cam e abaixo serão apontados alguns aspectos observados.
   * Pontos positivos
